package projeto.br.com.dio;

import projeto.br.com.dio.repository.InvestmentRepository;
import projeto.br.com.dio.exception.AccountNotFoundException;
import projeto.br.com.dio.exception.NoFundsEnoughException;
import projeto.br.com.dio.exception.WalletNotFoundException;
import projeto.br.com.dio.model.AccountWallet;
import projeto.br.com.dio.repository.AccountRepository;
...
public class Main {
    ...
    public static void main(String[] args) {
        System.out.println("Olá, Seja bem vindo ao DIO Banck");
        while (true) {
            ...
            switch (option) {
                ...
                case 12 -> {
                    ...
                    System.out.println("Investimentos reajusta");
                }
