...
import projeto.br.com.dio.exception.PixInUseException;
...
public class AccountRepository {
    ...
    public AccountWallet findByPix(final String pix){
        return accounts.stream()
                        ...
                        .findFirst()
                        .orElseThrow(() -> new AccountNotFoundException("A conta com a chave "+ pix +" não existe"));
    }
    ...
    public Map<OffsetDateTime, List<MoneyAudit>> getHistory(final String pix){
        ...
        return audit.stream().collect(Collectors.groupingBy(t -> t.createAt().truncatedTo(SECONDS)));
    }
}
