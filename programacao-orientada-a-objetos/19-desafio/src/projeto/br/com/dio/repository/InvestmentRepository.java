...
import projeto.br.com.dio.exception.AccountWithInvestmentException;
import projeto.br.com.dio.exception.InvestmentNotFoundException;
import projeto.br.com.dio.exception.WalletNotFoundException;
import projeto.br.com.dio.model.AccountWallet;
import projeto.br.com.dio.model.Investment;
import projeto.br.com.dio.model.InvestmentWallet;
...
public class InvestmentRepository {
    ...
    public InvestmentWallet withdraw(final String pix, final long funds){
        var wallet = findWalletByAccountPix(pix);
        CommonsRepository.checkFundsForTransaction(wallet.getAccount(), funds);
